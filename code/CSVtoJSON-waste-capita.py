...
INPUT_CSV = "plastic-waste-per-capita.csv"
OUTPUT_JSON = "plastic-waste-per-capita.json"
...
def select_data(file):
    ...
    for row in reader:
        data[row['Code']] = row['Per capita plastic waste (kilograms per person per day)']
